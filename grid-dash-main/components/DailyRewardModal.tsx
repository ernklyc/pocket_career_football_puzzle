...
const DailyRewardModal: React.FC<DailyRewardModalProps> = ({ isOpen, onClaim, onClose }) => {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
              ...
              if (modalRef.current) {
                ...
                triggerParticles(rect.width / 2, rect.height / 2, 'confetti');
              }
    ...
    <div
      ...
      role="dialog"
    >
        <div ref={modalRef} className="relative bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-700 via-slate-900 to-black rounded-2xl p-6 sm:p-8 max-w-md w-full text-center border-2 border-sky-400/50 shadow-2xl modal-fade-in-scale overflow-hidden">
