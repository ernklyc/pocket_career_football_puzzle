...
const LevelPreview: React.FC<LevelPreviewProps> = ({ gridSize, blockTypes }) => {
  return (
    <div
      className="absolute right-full mr-4 top-1/2 -translate-y-1/2 w-max p-3 bg-surface/95 backdrop-blur-md rounded-lg shadow-lg border border-slate-200 pointer-events-none z-20 animate-level-preview"
      role="tooltip"
    >
      <h4 className="text-xs font-bold text-text-secondary mb-2 border-b pb-1">Önizleme</h4>
