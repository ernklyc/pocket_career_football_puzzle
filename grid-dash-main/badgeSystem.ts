...
// Fix: Create a wrapper for StarIcon to make it compatible with the Badge 'icon' prop type.
// This wrapper ensures the star is always filled and appropriately sized for a badge.
const BadgeStarIcon: React.FC<{ className?: string }> = () => {
  return React.createElement(StarIcon, { filled: true, size: 32 });
};
...
export const allBadges: Badge[] = [
  ...
  },
  {
    ...
    // Fix: Use the BadgeStarIcon wrapper to resolve the type incompatibility.
    icon: BadgeStarIcon,
  },
  {
